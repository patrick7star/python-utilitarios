...
if __name__ == "__main__":
   ...
   t.circula(Ponto(t.linhas-5, t.colunas-10),
   ...
   (P, Q) = Ponto(0, t.colunas-compr), Ponto(compr, t.colunas)
   t.circula(P, Q)

   (P, Q) = Ponto(t.linhas-compr, t.colunas-compr), Ponto(t.linhas, t.colunas)
   t.circula(P, Q)

   (P, Q) = Ponto(0, int(t.colunas/2)-compr), Ponto(compr, int(t.colunas/2))
   t.circula(P, Q)

   (P, Q) = Ponto(t.linhas-compr, int(t.colunas/2)-compr), Ponto(t.linhas, int(t.colunas/2))
   t.circula(P, Q)

   (P, Q) = Ponto(compr+3, 0), Ponto(2*compr, 17)
   t.circula(P, Q)

   (P, Q) = Ponto(int(t.linhas/2), t.colunas-17), Ponto(int(t.linhas/2)+compr, t.colunas)
   t.circula(P, Q)
